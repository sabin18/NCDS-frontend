...
const searching = (search) => (x) => x.phoneNumber.toLowerCase().includes(search.toLowerCase())
                ...
                .filter(searching(search)).map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.isActive === true ? 'YES' : 'NO'}</TableCell>
                      <TableCell align="right">{row.roles.name}</TableCell>
